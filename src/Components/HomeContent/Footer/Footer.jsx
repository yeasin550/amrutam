        ...
        <div className="bg-[#1E1E1E] text-[#bcbec2] mt-12">
            <div className="w-11/12 mx-auto md:px-28 py-12 grid grid-cols-2 md:grid-cols-4 gap-12 justify-between">
                <div className="space-y-4">
                    A M R U T A M
                    <p>Travel Blog Elementor Template <br /> Kit. Powered by Design8. All <br /> rights reserved.</p>
                ...
                <div className="space-y-3 md:mr-0 mr-2">
                    ...
                    <p className="flex  gap-2"><FaSearchLocation className="mt-2 text-[#C0771E] text-[20px]" /> Kha-12/2(4th floor), Pragati <br /> Sarani, Gulshan, Dhaka-1212, <br /> (Near American Embassy)</p>

                    <p className="flex items-center gap-2"><FaPhone className="text-[#C0771E] text-[20px]" /> +880 1607-002687</p>

                    <p className="flex items-center gap-2"><FaMessage className="text-[#C0771E] text-[20px]" /> info@northway.com</p>
                </div>
